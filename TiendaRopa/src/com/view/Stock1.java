...
public class Stock1 extends javax.swing.JFrame {
    ...
    try {
        ...
        // Si todo está correcto, calculamos el subtotal
        int subtotal = cantidad * precio;

        // Agregar los datos a la tabla
        DefaultTableModel modelo = (DefaultTableModel) TableStock.getModel();
        modelo.addRow(new Object[]{idRopa, articulo, precio, cantidad, sucursal, subtotal});
    ...
    int filaSeleccionada = TableStock.getSelectedRow(); 
    ...
    try {
        ...
        modelo.setValueAt(sucursal, filaSeleccionada, 4); // Columna 4: Sucursal
        modelo.setValueAt(subtotal, filaSeleccionada, 5); // Columna 5: Subtotal
